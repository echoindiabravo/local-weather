...
const Current = ({weather, location, units}: CurrentProps) => (
  <div className="current">
    ...
    <div className="six-columns forecast-main">
      <span className="icon"><img src={icons[weather.currently.icon].src} alt={icons[weather.currently.icon].alt} style={{width: '50px', height: '50px'}} /></span>
      <span className="temp"> {units === 'F' ? Math.round(weather.currently.temperature) : Math.round(toCelsius(weather.currently.temperature))}&#176; </span>
    ...
    <div className="six-columns earthwindfire">
      ...
      <span className="feelsLike">Feels Like: {units === 'F' ? Math.round(weather.currently.apparentTemperature) : Math.round(toCelsius(weather.currently.apparentTemperature))}&#176;</span>
      <br />
